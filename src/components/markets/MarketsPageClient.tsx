// src/components/markets/MarketsPageClient.tsx
'use client';

import { useEffect, useState } from 'react';
import Image from 'next/image';
import Link from 'next/link';
import type { SummaryArticle } from '@/types/markets';
...
export default function MarketsPageClient({ articles, initialArticleId }: Props) {
