...
export default function TechPageClient({ articles, initialArticleId }: Props) {
            ...
            {!selected ? (
              <div className="geo-empty">
                ...
                <p className="geo-empty-text">
                  Daily tech briefings will appear here once the pipeline has run. Trigger
